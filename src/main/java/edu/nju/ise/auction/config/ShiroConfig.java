package edu.nju.ise.auction.config;

import edu.nju.ise.auction.interceptor.JwtFilter;
import edu.nju.ise.auction.shiro.CustomRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean factory(SecurityManager securityManager) {
        ...
        ruleMap.put("/api/auth/token", "anon");
        // 访问 /user/register 用户注册路径不通过JwtFilter
        ruleMap.put("/api/user/register", "anon");
        // 访问 /unauthorized/** 不通过JwtFilter
        ruleMap.put("/unauthorized/**", "anon");

        ruleMap.put("/images/**", "anon");

        ruleMap.put("/api/image/list", "anon");
