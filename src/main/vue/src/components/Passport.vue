      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="登录" name="login">
          <el-alert :title="loginMessage.text" type="error" show-icon v-if="loginMessage.show"
                    @close="closeLoginMessage()"></el-alert>
        ...
        <el-tab-pane label="注册" name="register">
          <el-alert :title="registerMessage.text" type="error" show-icon v-if="registerMessage.show"
                    @close="closeRegisterMessage()"></el-alert>
          <el-form status-icon :model="registerForm" :rules="registerRules" ref="registerForm">
            ...
            <el-form-item>
              <el-button class="login" type="primary" size="small" @click="register()">注册</el-button>
            </el-form-item>
          </el-form>
        </el-tab-pane>
      </el-tabs>
    ...
    methods: {
      ...
      login: function () {
        this.$refs['loginForm'].validate((valid) => {
          if (valid) {
            let self = this;
            post('api/auth/token', this.loginForm)
              .then(res => {
                if (!res.success) {
